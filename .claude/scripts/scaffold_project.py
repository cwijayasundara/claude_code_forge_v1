...
- `/forge:build` -- Start a new project from scratch
- `/forge:add-feature` -- Add a feature to an existing project
- `/forge:resume` -- Resume an in-progress pipeline
- `/forge:validate` -- Run all quality checks
